...
# Calculating Correlation between History and English variables using pandas
correlation = df.corr()
print("Correlation between History and English variables:", correlation.loc['History', 'English'])

# Calculating Pearson's Correlation using numpy
corr = np.corrcoef(df['History'], df['English'])
print("Correlation matrix:\n", corr)

# Calculating Pearson's Correlation using scipy
list1 = df['History']
list2 = df['English']
